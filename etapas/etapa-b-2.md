...
- [ ] **Task B2.1:** Desarrollar el layout funcional de los 3 Subsuelos (S1, S2, S3) integrando las **3 torres** directamente sobre la huella completa de $3.145\text{ m}^2$. Definir cocheras, rampas ($i \le 15\%$), Bloque Técnico, Cisterna y PTAR.
...
|---|---|---|---|
| 2026-09-19 | **Layout Subsuelos S1-S3 Unificados** | Huella de $3.145\text{ m}^2$ integrada con módulos de $2,50 \times 5,00\text{ m}$ y pasillos de maniobra $W \ge 6,00\text{ m}$. | ⏳ En desarrollo |
| 2026-09-19 | **Ubicación PTAR en Subsuelo S3** | Recinto estanco aislado de $120\text{ m}^2$ con ventilación mecánica forzada ([Ord. 030/2020 Art. 5°](visor_ordenanzas.html?id=2462)). | ✅ Definido |
